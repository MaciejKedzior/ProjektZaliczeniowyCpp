...
int main(void){
    ...
    cards.emplace_back(new JednostkaObl("Balista", "Oh jak ogromna!", 6, "balista.jpg"));
    cards.emplace_back(new BliskieStarcie("Komandos Niebieskich Pasow", "Chlop na schwal", 3, "komandos.jpg"));
    cards.emplace_back(new DalekiZasieg("Yennefer", "Najwieksza milosc Geralta", 7, "yennefer.jpg"));
